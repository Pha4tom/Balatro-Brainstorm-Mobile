...
- Searches seeds using your Brainstorm settings (Charm Tag, Economy Tag, etc)
- Soul card search support via Brainstorm's soul search setting
- Pack search support
- Made to work fully on Android and IOS
...
## How to Use
1. Open Brainstorm settings in-game and set your targeted tag/soul/pack target
2. Press **Auto Reroll** from the pause menu or game over screen
3. The mod will search 50,000 seeds and start a run with a matching one
