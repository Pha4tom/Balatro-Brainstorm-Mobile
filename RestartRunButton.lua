...
function create_UIBox_game_over()
    ...
    if G.STATE ~= G.STATES.MENU then
        local restart_run_button = {
            n=G.UIT.R, config={align="cm", minw=5, padding=0.1, r=0.1, hover=true, colour=HEX('00A000'), button="restart_run_button", shadow=true}, nodes={
